...
public enum HelpOut {
    ...
    DESCRIPTIONEXECUTESCRIPT ("execute_script file_name","Считает и исполняет скрипт из указаного файла. В скрите содержаться команды в таком же виде, в котором их вводит пользователь в интерактивном режиме"),
